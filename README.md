...
- Programming language **C++** is used instead of modern ones like Java or Typescript because of it's close coupling to **memory and hardware**; it's compiled runnable is very fast, necessary for a realtime system as shown here.      
