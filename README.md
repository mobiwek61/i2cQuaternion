...
**sensor fusion** steps in to combine data into something usable, where values are in the frame of reference to the you on  the Earth's surface, your local horizon, and North. This is better seen as **Roll, Pitch and Yaw**.  This describes how to build a system using an IMU which does it's own **sensor fusion**, right on the chip.    
