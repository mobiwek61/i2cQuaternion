...
Use of **interrupts** brings in the need for a **multi-threaded architecture**, made even better by multi-core processors (Esp32s3 has 2). Threads[aka tasks], semaphores and mutex'es, are taken care of by **freeRTOS**, built right into the esp32s3 and used by this code.  In-code documentation indicates where and how it's used.      
