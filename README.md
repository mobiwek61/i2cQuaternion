...
- My next TODO is to add **BLE** [bluetooth low energy] communication to a React web app.  This means that you write a web app (using ThreeJS for example) and don't have to know a thing about C++, freeRTOS and all the stuff I'm about to detail. ThreeJS likes quaternions also.
